...
path('see-question/<int:pk>/', views.see_question_view,name='see-question'),
    ...
    path('teacher-approve-student/<int:pk>/', views.teacher_approve_student_view,name='teacher-approve-student'),
    path('teacher-reject-student/<int:pk>/', views.teacher_reject_student_view,name='teacher-reject-student'),
    path('teacher-approve-all-students/', views.teacher_approve_all_students_view,name='teacher-approve-all-students'),
]
