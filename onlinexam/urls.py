...
urlpatterns = [
    ...
    path('papersubmission/',include(('papersubmission.urls', 'papersubmission'), namespace='papersubmission')),
    path('studentprofile/',include('studentprofile.urls')),
    


    path('',views.home_view,name='home'),
    path('logout/', LogoutView.as_view(template_name='exam/logout.html', next_page='/'),name='logout'),
    ...
    path('approve-all-teachers', views.approve_all_teachers_view,name='approve-all-teachers'),
    ...
    path('approve-all-students', views.approve_all_students_view,name='approve-all-students'),
